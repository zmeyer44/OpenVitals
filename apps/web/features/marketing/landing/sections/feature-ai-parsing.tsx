            ...
            <div className="px-5 py-5 flex flex-col gap-4">
              <div>
                ...
                <p className="mt-2 font-display text-[14px] text-neutral-500 leading-[1.6]">
                  ...
                  extracts every value, normalizes units, and maps to standard
                  medical codes — with confidence scores on every extraction.
                </p>
              </div>
              <Link href="/register">
          ...
          <div className="px-10 py-14">
              ...
              {pipelineSteps.map((step, i) => (
                <div key={step.label} className="flex items-center gap-1">
                  ...
                  {i < pipelineSteps.length - 1 && (
                    <span className="text-neutral-300 font-mono text-[8px]">
                      →
                    </span>
                  )}
                </div>
            ...
            >
              ...
              <div
                ...
                style={{
                  animation: "parseScan 3s ease-in-out forwards",
                  animationDelay: "0.5s",
                  opacity: 0,
                  top: 0,
                }}
